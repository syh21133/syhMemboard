					...
					<div class="row">
						...
						<div class="col-12 col-md-12 col-xxl-6 d-flex order-3 order-xxl-2">
							...
							<div class="card-header">
									...
									<h5 class="card-title mb-0">채팅창</h5>
								</div>
								<c:choose>
						...
						<div class="col-12 col-md-12 col-xxl-6 d-flex order-3 order-xxl-2">
							<div class="card flex-fill">
								<div class="card-header">
									...
									<h5 class="card-title mb-0">조회수 많은 글</h5>
								</div>
						...
						<tbody>
							<c:forEach var="list" items="${index}">
								<tr>
						...
						<div class="col-12 col-md-12 col-xxl-6 d-flex order-3 order-xxl-2">
							<div class="card flex-fill">
								<div class="card-header">
									...
									<h5 class="card-title mb-0">최근 올라온 글</h5>
								</div>
								<table class="table table-hover my-0">
						<thead>
							<tr>
